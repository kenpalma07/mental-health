...
const dataschoolage = Array.from({ length: 8 }, (_, i) => ({
  id: i +1,
...
const paginatedData = dataschoolage.slice((currentPage - 1) * itemsPerPage, currentPage * itemsPerPage);
const totalPages = Math.ceil(dataschoolage.length / itemsPerPage);
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6">
          <div className="flex flex-col items-center mb-6">
            <h1 className="text-xl font-semibold uppercase text-gray-800">
              Suicide Incidence Report (School Age)
            </h1>
            ...
            <table className="min-w-full text-sm text-left text-gray-700">
              <thead className="bg-black text-xs text-white border-b">
                <tr className="bg-black text-white text-center">
                  ...
                  <th className="border border-black p-2">Contact No. of Guardian</th>
                  <th className="border border-black p-2">Grade/Year</th>
                  <th className="border border-black p-2">School</th>
              ...
              <tbody>
                  ...
                  <tr key={item.id}className="hover:bg-gray-50 text-center">
                    ...
                    <td className="border p-2 text-center">{item.guardiancont}</td>
                    <td className="border p-2 text-center">{item.grade}</td>
                    <td className="border p-2 text-center">{item.school}</td>
