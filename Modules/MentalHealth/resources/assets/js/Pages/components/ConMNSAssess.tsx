...
const categories = [
    {
        ...
        groups: [
            {
                label: 'Depression',
                items: ['Low energy, fatigue, sleep problems', 'Anxiety', 'Persistent sadness', 'Loss of interest', 'Act of self-harm'],
            },
            {
                label: 'Psychosis',
                items: ['Mark behavioral changes', 'Agitated, aggressive behavior', 'Hearing voices or seeing things', 'Lack of realization'],
            },
            {
                label: 'Dementia',
                items: ['Severe forgetfulness', 'Loss of emotional control', 'Apathy'],
            },
            {
        ...
        groups: [
            {
                ...
                items: ['Diabetes Mellitus', 'Hypertension', 'Asthma', 'Heart Disease', 'Thyroid problem', 'Arthritis', 'Cancer', 'Others'],
            },
        ],
    },
    {
        ...
        groups: [
            {
                label: 'MNS History',
                items: ['Depression', 'Anxiety Disorder', 'Bipolar', 'Psychosis', 'Alcohol Use', 'Others'],
            },
        ],
    },
    {
        ...
        groups: [
            {
                ...
                items: ['Depression', 'Anxiety', 'Bipolar', 'Psychosis'],
            },
        ],
    },
];
        ...
        <div className="mt-2 w-full overflow-hidden rounded-lg border">
            <div className="flex w-full items-center bg-blue-500 px-4 py-3">
                <h6 className="w-full text-lg font-semibold text-white">
                    ...
                    <span className="text-sm text-white italic"> (refer to mhGAP-IG version 2.0p.9)</span>
                </h6>
            </div>
                    ...
                    <div key={title}>
                        ...
                        <div className="mt-2 flex flex-wrap gap-4">
                            {groups.map(({ label, items }) => (
                                <div key={label} className="min-w-[250px] flex-1">
