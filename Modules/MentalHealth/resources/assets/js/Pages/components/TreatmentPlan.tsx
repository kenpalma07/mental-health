...
export default function TreatmentPlan() {
  ...
  return (
    <div className="rounded-lg border overflow-hidden mt-4 w-full">
      <div className="bg-blue-500 px-4 py-3 flex items-center">
        <h6 className="text-lg font-semibold text-white w-full">
          ...
          <span className="text-sm italic text-white"> (Treatment Plan)</span>
        </h6>
      </div>
      <div className="p-6 space-y-6"> {/* Added vertical spacing */}
