          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div>
              <Label htmlFor="pat_birthplace">
                Birth Place <span className="text-red-600 font-bold">*</span>
              </Label>
              <Input
                id="pat_birthplace"
                className="text-dark-500"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div>
              <Label htmlFor="zipcode">
                Zip Code <span className="text-red-600 font-bold">*</span> 
              </Label>
              <Input
                id="zipcode"
                className="text-dark-500"
            ...
            <div>
              <Label htmlFor="country_code">
                Country Code <span className="text-red-600 font-bold">*</span>
              </Label>
              <Select
                id="country_code"
